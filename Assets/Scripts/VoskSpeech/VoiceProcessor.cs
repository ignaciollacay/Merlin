...
// TODO: Decouple AudioDeviceManager from RealtimeAudioProcessing
/// <summary>
...
public class VoiceProcessor : MonoBehaviour
{
    ...
    /// </summary>
    public event Action<short[]> OnFrameCaptured; // SpeechCaptured

    /// <summary>
    /// Event when audio capture thread stops
    /// </summary>
    public event Action OnRecordingStop; // SpeechEndDetected

    /// <summary>
    /// Event when audio capture thread starts
    /// </summary>
    public event Action OnRecordingStart; //SpeechStartDetected
    ...
    IEnumerator RecordData()
    {
        ...
        while (IsRecording)
        {
            ...
            // TODO: private bool TryDetectAudio(out bool _audioDetected)
            ...
            // TODO: RaiseAudioEvents()
            if (_audioDetected) // Detected Speech
            {
                // TODO: SendAudioSample()
                _didDetect = true;
                ...
                if (OnFrameCaptured != null && _transmit)
                    OnFrameCaptured.Invoke(pcmBuffer); // TODO: Key Behavior. Event with Speech Audio data
            }
            else // Detected Silence
            {
                // TODO: StopRecording()
                if (_didDetect) // After Recognizing.
                {
                    if (OnRecordingStop != null)
                        OnRecordingStop.Invoke();  // TODO: Key Behavior. Raise Speech End Detected Event
                    _didDetect = false;
                }
            }
        }
