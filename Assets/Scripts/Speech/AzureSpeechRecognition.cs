...
public class AzureSpeechRecognition : MonoBehaviour
{
    public static AzureSpeechRecognition Instance { get; set; }
...
public class SpeechRecognition : MonoBehaviour
{
    ...
    [Tooltip("Add custom keywords to Phrase List")]
    [SerializeField] private string[] customKeywords;
    [Tooltip("List of keywords added by PhraseRecognition to PhraseListGrammar")]
    ...
    private async void StartContinuousRecognition()
    {
        ...
        if ((customPhraseList) || (automaticPhraseList))
        {
            CreatePhraseList();
            Debug.Log("Creating Phrase List");
        }
        ...
        {
            Debug.Log("Phrase list could not be created.");
        }
